...
#   downloaded at: '2019-11-01 11:36:48' (do not edit this!)
#   downloaded ip: '128.237.157.147' (do not edit this!)
#   security code: '3230222341497074346GMEROYDCRERGZ1ENY1GGY' (do not edit this!)
...
def power(base, expt):
    if expt == 0:
        return 1.0
    if expt < 0:
        return base / power(base, (expt*-1)+1)
    else:
...
def mergeSort(L):
    if len(L) < 2:
        ...
        mid = len(L)//2
        return merge(mergeSort(L[0:mid]), mergeSort(L[mid:]))
